...
function EventDetails() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      <div className="relative w-full h-auto rounded-xl overflow-hidden mb-6">
        <img
          src={event.image}
          alt={event.title}
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
        <div className="bg-white rounded-lg p-4 border">
          <div className="flex items-center gap-2 mb-1">
            <img 
              src="https://img.icons8.com/?size=100&id=10053&format=png" 
              alt="calendar icon"
              className="w-4 h-4"
            />
        ...
        <div className="bg-white rounded-lg p-4 border">
          <div className="flex items-center gap-2 mb-1">
            <img 
              src="https://img.icons8.com/?size=100&id=10034&format=png" 
              alt="clock icon"
              className="w-4 h-4"
            />
        ...
        <div className="bg-white rounded-lg p-4 border">
          <div className="flex items-center gap-2 mb-1">
            <img 
              src="https://img.icons8.com/?size=100&id=88940&format=png" 
              alt="duration icon"
              className="w-4 h-4"
            />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
        ...
        <div className="bg-gray-50 rounded-lg p-6">
          <div className="flex items-center gap-2 mb-3">
            <img 
              src="https://img.icons8.com/?size=100&id=Hh5ONdvsAI4P&format=png&color=01BBC1" 
              alt="location icon"
              className="w-5 h-5"
            />
          ...
          <a
            ...
            className="text-[#01BBC1] hover:text-[#019ca1] hover:underline text-sm inline-block mt-2"
          >
            View Map →
          </a>
        </div>
      ...
      <div className="mb-8">
        <div className="flex items-center gap-2 mb-3">
          <img 
            src="https://img.icons8.com/?size=100&id=1ztfvElILGPO&format=png&color=000000" 
            alt="tickets icon"
            className="w-5 h-5"
          />
      ...
      <div className="mt-8">
        <button className="w-full max-w-md mx-auto block bg-[#000000] text-white py-3 px-6 rounded-full text-base font-semibold hover:bg-[#019ca1] transition-colors">
          Buy Ticket
        </button>
      </div>
    </div>
